...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         ...
         title: {
            text: 'Data Penjualan PerBulanan'
         },
         xAxis: {
...
$bulan=$_GET['bulan'];       
	$sql_jumlah   = "SELECT id_barang,sum(jumlah_barang) as Jumlah
from penjualan
...
<div id="container5" style="min-width: 200px; height: 400px; margin: 0 auto"></div>
